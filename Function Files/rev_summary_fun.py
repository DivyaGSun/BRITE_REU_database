...
def show_past_revs():
    ...
    print('''<div id ="topnav">
      ...
      <a  class = "active" href="https://bioed.bu.edu/cgi-bin/students_21/group_proj/group_K/main.py?t_ID=6">My Past Reviews</a>
    ...
    print('''<form name="ReviewForm" action="https://bioed.bu.edu/cgi-bin/students_21/group_proj/group_K/main.py" method="post" >
