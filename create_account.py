...
print('''
<form id="my_form" form action="https://bioed.bu.edu/cgi-bin/students_21/group_proj/group_K/create_account.py" method="post">
    <p class="clearfix">
    ...
    <p class="clearfix">
        ...
        <input type="password" id= "rpt_pass" placeholder="Repeat Password" required>
    </p>
    <p class="clearfix">
